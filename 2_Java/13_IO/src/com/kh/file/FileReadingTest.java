...
//		f.fileRead2();
	...
	public void fileReadToSave() {
		 ...
		 * */
//		try(FileReader fr = new FileReader(fileName);	// 읽어오기
//				BufferedReader br = new BufferedReader(fr); // BufferedReader가 있으면 한 줄씩 가지고 올 수 있음
//				/* ↑ 입력과 관련된 코드. ↓ 출력과 관련된 코드 */
...
//				BufferedWriter bw = new BufferedWriter(fw);) { 
		...
		try(
			...
			String line = "";
			while((line = br.readLine()) != null) {
				//System.out.println(line); // 단순히 콘솔에 보여지는 코드
				//bw.write(line);
