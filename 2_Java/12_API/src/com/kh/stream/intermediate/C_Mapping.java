...
public class C_Mapping {
	...
	public void method1() {
		...
		// 수학 점수의 평균(average)
//		OptionalDouble avg = students.stream().mapToInt(student -> student.getMath())
//			.average();
//		System.out.println(avg); // OptionalDouble[69.16666666666667] >> Optional 객체로 출력됨
		
		double avg = students.stream()
					.mapToInt(student -> student.getMath())
					.average()
					.getAsDouble();
		System.out.println(avg); // 69.16666666666667
	}
