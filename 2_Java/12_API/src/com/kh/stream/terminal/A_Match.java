...
public class A_Match {
	...
	public void method1() {
		...
		result = Arrays.stream(values).anyMatch(value -> value % 3 == 0); // anyMatch 하나라도 가지고 있는가
...
//							.allMatch(student -> student.getGender().equals("남자"));
							.allMatch(student -> student.getAge() >= 20 && student.getGender().equals("남자")); // 두 조건 한번에 사용하면 조건 애매해짐. 비추
