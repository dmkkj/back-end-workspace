...
import java.net.URL;
// 네트워크 : 서버와 클라이언트 간의 통신
/*
 * URL(Uniform Resource Locator) 
 * - 인터넷에 존재하는 서버들의 자원에 접근할 수 있는 주소
 * 
 * https://www.youtube.com/results?search_query=푸바오
...
public class URLTest {
	...
	public void method1() {
		try { // 파일 처리, 전송 방식 등 보통 잘못 작성했을 수도 있고, 없을 수도 있어서 try~catch 처리
			URL url = new URL("https://www.youtube.com/results?search_query=푸바오");
