...
public class B_Casting {
	 ...
	 * - boolean을 제외한 7개의 기본형은 서로 형변환이 가능. boolean만 형 변환 안 된다는 것만 기억
	 * */
...
//		casting.autoCasting();
	...
	public void autoCasting() {
		// 정수
		byte b = 10; // 1byte
		short s = b; // 2byte >> short b = 10; byte s = b; 데이터 타입 크기 때문에 안 들어감
		int i = s; // 4byte
		long l = i; // 8byte
		...
		int result2 = b + s; // byte, short 타입의 데이터는 연산 시 무조건 int 타입으로 변환
	...
	public void casting() {
		...
		int sum2 = (int) (i + d); // 4.0 + 4.123456789012345 계산 후에 자름
