...
//		variable.variableTest();
	...
	public void printValue() {
		...
		// 변수를 사용하지 않고
		System.out.println(10 * 2 * 3.141592); // syso 입력 후 ctrl + 스페이스바 -> Enter!
		...
		// 변수를 사용하면
		int r = 30;
		double pi = 3.141592; // 소수점을 포함한 실수를 담는 데이터 타입
	...
	public void variableTest() {
		...
		// 2. 문자형 : 2byte(=16bit)
		char ch = 'a'; // char라는 자료형에 a라는 값을 넣고 b라는 값으로 바꿈
//		ch = 'ab'; 에러 발생! --> 주석 단축키 : ctrl + / , 문자열은 '' ("" 쌍따옴표 사용 불가)
		
		// 3. 정수형
		byte bNum = 1; // 1byte(=8bit)(-128 ~ 127) 256 = 2^8
//		bNum = 128; 에러 발생! -> 오버플로우(Overflow) 해당하는 변수의 값이 넘치는 것. 127까지밖에 못 오는데 그 이상의 수가(128) 들어오는 것
		...
		// ↓ String. 자바가 제공하는 클래스로, 클래스가 자료형 형태로 온다
