...
public class Calculator {
	 ...
	 * */
	public int a, b; // public int a; public int b; 한 줄로 줄이기
	
	public int add() { // public void add() // 반환값의 타입으로 변경 void -> int
		return a + b;
	}
...
//			System.out.println(i);
	...
	public int factorial2(int n) {
		...
		// n 반복 호출. factorial2(n-1)
		// 자기 자신을 계속 호출하면서 n-1 되면서 n = 0까지
