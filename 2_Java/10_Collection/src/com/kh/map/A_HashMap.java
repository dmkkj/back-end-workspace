...
public class A_HashMap {
	...
	public void method1() {
		Map<String, Integer> map = new HashMap<>();	// key 형태, value 형태 두 가지 다 명시를 해줘야 함
		map.put("웨하스", 250);
		map.put("고래밥", 180);
		map.put("칸쵸", 800);
		map.put("나쵸", 450);
		...
		for(String s : key) {
			System.out.println(s + " : " + map.get(s));	// 웨하스 : 250 고래밥 : 180 나쵸 : 450 칸쵸 : 800
		}
	...
	public void method2() {
		...
		System.out.println("과자의 개수 : " + map.size());	// key 값은 중복이 안 되기 때문에. 웨하스 중복이라 1개로 count
