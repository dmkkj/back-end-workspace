...
SELECT * FROM kh.employee; -- emp_name, dept_code, bonus
SELECT * FROM kh.department; -- dept_id, dept_title, location_id
SELECT * FROM kh.location; -- local_code, local_name
...
UPDATE emp_salary
SET bonus = 0.3
WHERE emp_id IN (SELECT emp_name, local_name, bonus
				FROM kh.location
